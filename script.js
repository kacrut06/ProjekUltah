...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Apr 27, 2024 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Assalamualaikum Wr. Wb", " ", "Saya Nur Setiawan pada hari ini Sabtu, 27 April 2024 dengan sepenuh hati mengucapkan", " ", "<b>Selamat Ulang Tahun Yang ke - 20</b>", " ", "Kepada Fildia Ika Saputri, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari saya", , " ", "Wassalamualakaikum Wr. Wb", " ", "- Awan Sullivan, Mas ganteng :)"],
  startDelay: 4000,
  speed: 75,
